...
class CountdownTimer:
    ...
    def start_timer(self):
        ...
        # Set the initial duration in minutes here
        self.remaining_time = int(self.minutes_entry.get()) * 60
...
def main():
    ...
    # Entry field for setting minutes
    app.minutes_entry = tk.Entry(root)
    app.minutes_entry.pack(pady=10)
    app.minutes_entry.insert(0, "Enter minutes")
